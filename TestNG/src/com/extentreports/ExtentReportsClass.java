...
public class ExtentReportsClass {
	...
	public void startReport() {
		...
		// report. If the supplied path does not exist, a new file will be created.
		extent = new ExtentReports(System.getProperty("user.dir") + "//test-output//STMExtentReport.html", true);
		// String path = System.getProperty("user.dir") + "//test-output//screenshots//"
		// + setCurrentDateTime()+" " +fileName + ".png";
...
//To generate the log when the test case is passed
	...
	public void getResult(ITestResult result) {
		...
		// ending test
		// endTest(logger) : It ends the current test and prepares to create a HTML
		// report
	...
	public void endReport() {
		...
		// If any of your tests ended abruptly causing any side-affects (not all logs
